...
BAG_FILE="/root/raspi_stream/record/imu-calib-timestamp/record_vidacc_stream-0000-$SIDE.rosbag"
...
# python kalibr_bagcreater_mov_omni --mov $MOV_FILE --acc $ACC_FILE --time $TIME_FILE --output-bag $BAG_FILE --side $SIDE

# # python kalibr_calibrate_cameras --bag $BAG_FILE --models ds-none --target $TARGET_YAML --topics /cam0/image_raw
# python kalibr_calibrate_cameras --bag $BAG_FILE --models pinhole-equi --target $TARGET_YAML --topics /cam0/image_raw
# # # mv #camchain txt
# # # mv #result txt

# CAMCHAIN_FILE="/root/raspi_stream/record/imu-calib-timestamp/camchain-record_vidacc_stream-0000.rosbag.yaml"
CAMCHAIN_FILE="/root/raspi_stream/record/imu-calib-timestamp/camchain-record_vidacc_stream-0000-$SIDE.rosbag.yaml"
